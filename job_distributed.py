...
#aviso
dask_jobs = 6  # number of dask pbd jobs
jobqueuekw = dict(processes=26, cores=26)  # uplet debug
...
def run_aviso(l, cluster, client):
    ...
    ds_data = ds_data.chunk({'obs':500, 'alti_time':-1, 'site_obs':-1})
...
if __name__ == "__main__":
    ...
    for l in labels : 
        ...
        #run_coloc(l, cluster, client)
        run_aviso(l, cluster, client)
