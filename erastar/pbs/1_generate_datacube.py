...
name = "erastar"
data_root = "/home/datawork-cersat-public/provider/woc/products/theme1/ocean_winds/woc-l4-se-erastar-h/v2.0/"
path_format = (
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog='ERASTAR generate datacube',
        description='Program to generate ERASTAR datacube'
    )
    ...
    dates = pd.date_range(args.start, args.end, freq="h")
